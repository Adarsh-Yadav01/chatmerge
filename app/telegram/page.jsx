...
export default function TelegramPage() {
  ...
  const [isTelegramAgreed, setIsTelegramAgreed] = useState(false);
  ...
  const cardData = {
    ...
    description: "Securely connect your Telegram account to enable automation features.",
    features: [
      { icon: "🔗", text: "Auto-reply messages" },
      { icon: "📈", text: "Analytics & tracking" },
      { icon: "🤖", text: "Auto message links" },
    ],
    imageSrc: fbimage,
    imageAlt: "Pro automation interface",
    button: "🔗 Connect Telegram Account",
    bgColor: "from-black via-black to-blue-400",
    btnColor: "from-black via-blue-600 to-blue-400",
  };
