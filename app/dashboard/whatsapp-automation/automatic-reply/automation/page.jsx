            ...
            <div className="space-y-3">
              <div className="flex space-x-2">
                <input
                  ...
                  className={`flex-1 p-2 text-base font-semibold border rounded focus:outline-none focus:ring-1 focus:ring-green-500 ${
                    anyKeywordMode
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all ${
                    anyKeywordMode || !keywordInput.trim()
                      ...
                      : "bg-gradient-to-br from-green-400 via-green-500 to-green-600 text-white cursor-pointer hover:bg-green-700"
                  }`}
                >
                  Add Keyword
                </button>
              ...
              {keywords.length > 0 && (
                <div className="flex flex-wrap gap-2 ">
                  {keywords.map((keyword, index) => (
                    <div
                      key={index}
                      className="flex gap-2 items-center bg-gradient-to-br from-green-400 via-green-500  to-green-600 text-white text-md font-medium px-4 py-1 rounded-full"
                    >
                      <span>{keyword}</span>
                      <button
            ...
            <div className="flex items-center mt-6 justify-between p-4 bg-gray-50 rounded-lg border shadow-sm">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out  ${
                  anyKeywordMode ? "bg-green-500" : "bg-gray-300"
                }`}
              >
                <span
            ...
            <AnimatePresence>
              {buttons.map((button, index) => (
                <motion.div
                  ...
                  className="p-4 border border-green-500 rounded-lg space-y-3 bg-black/2"
                >
