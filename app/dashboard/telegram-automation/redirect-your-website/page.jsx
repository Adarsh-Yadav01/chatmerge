              ...
              <div className="order-2 lg:order-1 p-4 sm:px-8 space-y-4 lg:space-y-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                    Whether you're promoting a new product or simply looking to
                    boost your online presence, this template is a powerful tool
                    for driving more traffic and engagement to your website.
                    <br />
                  ...
                  <ol className="list-decimal list-inside text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                    <li>You create Keyword.</li>
                    <li>Contact sends a message with one of these Keywords.</li>
                    <li>
                      Automation sends a link to a website or some particular
                      page.
                    </li>
                  </ol>
                </div>
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 pt-4 sm:pt-6 px-2">
                  <Link
                    href="/dashboard/telegram-automation/redirect-your-website/automation"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">
                    Redirect customers to your website Automation Saved History
                  </h2>
                </div>
