...
import PreviewBoxTgleadflow from "../../../../components/PreviewBoxTgleadflow";
...
export default function AutoDMCommentLinkPage() {
  ...
  const [buttons, setButtons] = useState([
    { name: "Yes", response: "🌶️ You can always find our hottest offers on this page: https://strch.quickshift.in/track", buttonLabel: "", linkUrl: "", imageUrl: "" },
  ]);
  ...
  const handleGreetingImageChange = useCallback((value) => {
    ...
    <div className="flex flex-col lg:flex-row p-2">
      <div className="flex-1 lg:order-1 lg:w-[600px]">
        <Automation
          ...
          onGreetingImageChange={handleGreetingImageChange}
          buttons={buttons}
