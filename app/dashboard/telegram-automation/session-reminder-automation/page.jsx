            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-4 items-center min-h-[400px] lg:min-h-[610px]">
              <div className="order-2 lg:order-1 p-4 sm:px-8 space-y-4 lg:space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-[#36AEE0] to-[#36AEE0] rounded-lg flex items-center justify-center flex-shrink-0">
                    <Image
                      src={Telegramlogo}
                      alt="whatsapp logo"
                      width={32}
                ...
                <div>
                  <h1 className="text-2xl sm:text-3xl lg:text-3xl xl:text-3xl font-bold text-gray-900 leading-tight">
                    Capture customer data with a lead
                  </h1>
                </div>
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                    Use a Rule for Contacts who register for your event. Automation continues the flow by sending a scheduled reminder, confirmation or cancellation message.                    <br />

                  </p>

                  <ol className="list-decimal list-outside pl-5 text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                    <li>You create Keyword.</li>
                    <li>
                      Contact sends a message with Keyword "leads". Triggers the automation to send
                      a message and button asking Contact if they're excited to receive eBook.
                    </li>
                    <li>
                      Automation asks for email, which contact can use in either ManyChat or in a
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 pt-4 sm:pt-6 px-2">
                  <Link
                    href="/dashboard/telegram-automation/session-reminder-automation/automation/"
