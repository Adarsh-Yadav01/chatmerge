...
import PreviewBoxTgreminder from "../../../../components/PreviewBoxTgreminder";
...
export default function AutoDMCommentLinkPage() {
  ...
  const [greetingAttachment, setGreetingAttachment] = useState({ url: "", name: "", type: "" });
  const [buttons, setButtons] = useState([
    { name: "Yes", response: "🌶️ You can always find our hottest offers on this page: https://strch.quickshift.in/track", buttonLabel: "", linkUrl: "", imageAttachment: { url: "", name: "", type: "" } },
  ]);
  ...
  const handleGreetingAttachmentChange = useCallback((value) => {
    setGreetingAttachment(value);
  }, []);
    ...
    <div className="flex flex-col lg:flex-row p-2">
      <div className="flex-1 lg:order-1 lg:w-[600px]">
        <Automation
          ...
          onGreetingAttachmentChange={handleGreetingAttachmentChange}
          buttons={buttons}
